...
public class ApiQueueStatsServletTest {

    private ApiQueueStatsServlet servlet;
    ...
    public void setUp() throws Exception {
        ...
        servlet = new ApiQueueStatsServlet();
    ...
    @Test public void testInstance1() { assertNotNull(new ApiQueueStatsServlet()); }
    @Test public void testInstance2() { assertNotNull(new ApiQueueStatsServlet()); }
    @Test public void testInstance3() { assertNotNull(new ApiQueueStatsServlet()); }
}
